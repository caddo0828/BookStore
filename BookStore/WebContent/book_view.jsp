...
<body>	
	...
	<div class="help"><a href="ShowCarServlet?method=showCar" class="shopping">购物车</a><a href="HistoryServlet?method=showHistory">订单历史记录</a><a href="/BookStore/register.html">注册</a><a href="UserServlet?method=loginOut">安全退出</a></div>
	<div class="navbar">
		<ul class="clearfix">
			<li class="current"><a href="ProductServlet?method=showHall">首页</a></li>
			<li><a href="BookServlet?method=showAllBook&pageNumber=${pageNumber}">图书</a></li>
			<li><a href="#">百货</a></li>
			<li><a href="#">品牌</a></li>
			<li><a href="#">促销</a></li>
		</ul>
...
<div id="main" class="wrap">
	<div class="lefter">
		<div class="box">
			...
			<dl>
				<dt>图书音像</dt>
				<dd><a href="BookServlet?method=showAllBook&pageNumber=${pageNumber}">图书</a></dd>
				<dt>百货</dt>
				<dd><a href="#">运动健康</a></dd>
				<dd><a href="#">服装</a></dd>
				<dd><a href="#">家居</a></dd>
