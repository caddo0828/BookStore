...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dt>图书信息</dt>
				<dd><em><a href="#">新增</a></em><a href="/BookStore/ManagerBookServlet.do?method=showBook">图书管理</a></dd>
				<dt>订单管理</dt>
	...
	<div class="main">
		...
		<div class="manage">
			<form action="/BookStore/ManagerBookServlet.do?method=add" method="post" enctype="multipart/form-data" onsubmit="return checkBookForm(this);">
				<table class="form">
					<tr>
						<td class="field">商品名称：</td>
						<td><input type="text" class="text" name="bookName"  onfocus="focusItem(this);"  onchange="checkBook(this);"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="file" class="text" name="imgurl" value=""/></td>
					</tr>
					<tr>
						<td></td>
