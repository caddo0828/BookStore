...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dt>图书信息</dt>
				<dd><em><a href="#">新增</a></em><a href="/BookStore/ManaFindBookServlet.do">图书管理</a></dd>
				<dt>订单管理</dt>
	...
	<div class="main">
		...
		<div class="manage">
			<form action="/BookStore/ManaBookUpload.do?type=add" method="post" enctype="multipart/form-data" onsubmit="return checkBookForm(this);">
				<table class="form">
					<tr>
