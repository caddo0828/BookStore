...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改用户  <b style="color: red;">${error}</b></h2>
		<div class="manage">
			<form action="/BookStore/ManagerUserServlet.do?method=update" method="post" onsubmit="return checkForm(this)">
				<table class="form">
					<tr>
						<td class="field">用户ID</td>
						<td><input type="text" class="text" name="uid" value="${param.id}" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">用户名：</td>
						<td><input type="text" class="text" name="userName" value="${param.userName}"  onfocus="focusItem(this);"  onchange="checkItem(this);"/></td>
					</tr>
					<tr>
						<td class="field">密码：</td>
						<td><input type="text" class="text" name="passWord" value="" onfocus="focusItem(this);" onblur="checkItem(this);"/></td>
					</tr>
					<tr>
						<td class="field">手机号码：</td>
						<td><input type="text" class="text" name="tel" value="${param.tel}" onfocus="focusItem(this);"  onchange="checkItem(this);" /></td>
					</tr>
					<tr>
						<td class="field">邮箱地址</td>
						<td><input type="text" class="text" name="email" value="${param.email}" onfocus="focusItem(this);" onchange="checkItem(this);"/></td>
					</tr>
					<tr>
						<td class="field">激活状态:</td>
						<td><input type="text" class="text" name="status" value="" onfocus="focusItem(this);" onblur="checkItem(this);"/></td>
					</tr>
					<tr>
						<td></td>
						<td><label class="ui-blue"><input type="submit" name="submit" value="更新用户信息" /></label><span></span></td>
					</tr>
				</table>
			</form>
		</div>
